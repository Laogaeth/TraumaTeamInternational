...
function phoneValidation(){
  ...
  let phoneNumber= document.querySelector('#phone').value; //nab input field value
  const phoneFirstValues= phoneNumber.substring(0,2) // grabs first 2 values
  
    if (phoneFirstValues != "91") {
      alert("Phone number must start with 91!");
    }
     
  } 
//reutilizado em JavascriptContacts.JS